...
@ComponentScans(value = { @ComponentScan("com.danilobuchner.cards.dao"),
      @ComponentScan("com.danilobuchner.cards.service") })
public class AppConfig {
   ...
   public LocalSessionFactoryBean getSessionFactory() {
      ...
      factoryBean.setPackagesToScan("com.danilobuchner.cards.entity");
